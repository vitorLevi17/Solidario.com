...
from .views import recebedor_inicio,recebedor_criar_doacao,aceitar_doacao#,alterar_doacao,recusar_doacao
...
urlpatterns = [
    ...
    # path('alterar_doacao/<int:doacao_id>/',alterar_doacao,name = 'alterar_doacao'),
